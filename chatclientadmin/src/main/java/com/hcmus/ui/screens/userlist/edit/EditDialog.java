...
public class EditDialog extends JDialog {
    ...
    public EditDialog(Table<User> tablePanel) {
        ...
        this.selectedUser = tablePanel.getSelectedData();
    ...
    private void onOK(ActionEvent ev) {
        ...
        User newUser = new User(selectedUser.getId(), username, password, name, email, sex, address, unixBirthday, System.currentTimeMillis() / 1000, false, false);
        try {
