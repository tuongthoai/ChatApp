...
public class RangeSelectorUI extends BasicSliderUI {
    private final Color rangeColor = Color.GREEN;
    private Rectangle upperThumbRect;
    private boolean upperThumbSelected;

    private transient boolean lowerDragging, upperDragging;
    public RangeSelectorUI(RangeSelector slider) {
        super(slider);
    }
    ...
    public void scrollByBlock(int direction){
        synchronized (slider) {
            ...
            if (upperThumbSelected){
                int oldValue = ((RangeSelector) slider).getUpperValue();
                ((RangeSelector) slider).setUpperValue(oldValue + delta);
            } else {
