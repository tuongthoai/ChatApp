...
CREATE TABLE USER_GCHAT_LIST (
    USERID INTEGER REFERENCES USER_METADATA (USERID),
    GROUPID INTEGER REFERENCES GCHAT_METADATA (GROUPID),
...
CREATE TABLE GCHAT_MEMBER (
    GROUPCHATID INTEGER REFERENCES GCHAT_METADATA (GROUPID),
...
INSERT INTO USER_GCHAT_LIST (USERID, GROUPID) VALUES
(1, 1), (2, 1), (3, 1), (4, 1),
(2, 2), (3, 2),
(2, 3), (3, 3), (4, 3),
(1, 4), (4, 4);
...
INSERT INTO GCHAT_MEMBER (GROUPCHATID, MEMBERID) VALUES
(1, 1), (1, 2), (1, 3), (1, 4),
(2, 2), (2, 3),
(3, 2), (3, 3), (3, 4),
(4, 1), (4, 4);

INSERT INTO GCHAT_CONTENT (GROUPID, USERSENT, MSG, MSG_OFFSET, SENTTIME) VALUES
...
INSERT INTO GCHAT_ADMINS (GROUPID, ADMINID) VALUES
(1, 1), (1, 2), (3, 2), (3, 4);

INSERT INTO GCHAT_OFFSET (GROUPID, USERID, LASTSEENOFFSET, LASTRECEIVEDOFFSET) VALUES
